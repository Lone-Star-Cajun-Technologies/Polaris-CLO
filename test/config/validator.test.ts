...
describe("validateConfig - paperclip execution config", () => {
  it("should accept a paperclip config without roleBindings or reportsTo", () => {
    const config = {
      execution: {
        adapter: "paperclip",
        paperclip: {
  ...
  it("should accept a paperclip config with roleBindings and reportsTo", () => {
    const config = {
      execution: {
        adapter: "paperclip",
        paperclip: {
          ...
          roleBindings: {
            ...
            analyst: "44444444-4444-4444-4444-444444444444",
          },
          reportsTo: {
            librarian: "analyst",
          },
