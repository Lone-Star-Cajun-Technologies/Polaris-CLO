...
- Worker, librarian, and Medic command groups exist for runtime-governed execution paths.
...
- SmartDocs migration now guarantees bundle-root scaffolding by creating `smartdocs/index.md` and `smartdocs/log.md` when missing during init/adopt migration paths, while preserving existing file content.
