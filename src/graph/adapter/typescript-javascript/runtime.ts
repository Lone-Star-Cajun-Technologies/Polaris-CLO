...
export type TypeScriptJavaScriptParserLanguage = "typescript" | "javascript";
...
export interface TreeSitterRuntime {
  parse(source: string, language: TypeScriptJavaScriptParserLanguage): ParseTreeLike;
}

interface LoadedTreeSitter {
  parserConstructor: ParserConstructorLike;
  languages: Record<TypeScriptJavaScriptParserLanguage, unknown>;
}
...
function getOrCreateParser(
  language: TypeScriptJavaScriptParserLanguage,
  loaded: LoadedTreeSitter,
  parserByLanguage: Map<TypeScriptJavaScriptParserLanguage, ParserInstanceLike>,
): ParserInstanceLike {
