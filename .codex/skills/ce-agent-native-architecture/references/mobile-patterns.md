...
class AgentOrchestrator {
    ...
    // Non-View class: read current values directly, or subscribe via Combine for reactive behavior.
    // Example: network.$isConnected.sink { isConnected in ... }.store(in: &cancellables)
