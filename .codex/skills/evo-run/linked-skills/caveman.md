...
description: Keep evo-run orientation and status reporting terse while preserving technical accuracy.
...
Keep evo-run orientation and status reporting terse while preserving technical accuracy.
