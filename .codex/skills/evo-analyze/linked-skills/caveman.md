...
description: Keep evo-analyze user-facing status updates terse while preserving planning and blocker detail.
...
Keep evo-analyze user-facing status updates terse while preserving planning and blocker detail.
...
- Do not compress child issue bodies
