...
Polaris is a managed repository for governed AI implementation workflows, route
cognition, SmartDocs, runtime artifacts, and cluster delivery.
...
2. Read `.polaris/skills/<target-skill>/SKILL.md` first, before repo inspection
